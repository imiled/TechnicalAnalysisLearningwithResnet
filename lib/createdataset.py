...
def main():
  ...
  _ =read_and_create_dataset_by_perc(path=input_path, range_list=range_list_, x_name='x_image.csv', y_name='y_stateclass.csv',validation_split=0.2)
  _ =read_and_create_dataset_by_number(path=input_path, range_list=range_list_,x_name='x_image.csv', y_name='y_stateclass.csv',nb_case_by_state_block=10)
