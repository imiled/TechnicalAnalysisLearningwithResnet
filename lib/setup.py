...
def main():
  ...
  create_directory('images/tmp/BB')
  create_directory('images/tmp/NB')
  create_directory('images/tmp/NN')
  create_directory('images/tmp/SN')
  create_directory('images/tmp/SS')
  create_directory('images/tmp/ER')
